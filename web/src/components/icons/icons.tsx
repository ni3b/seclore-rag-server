...
import awsWEBP from "../../../public/logo.webp";
...
import freshdeskSolutionIcon from "../../../public/Freshdesk_Solutions.png";
...
export const FreshdeskSolutionIcon = ({
  size = 20,
  className = defaultTailwindCSS,
}: IconProps) => (
  <LogoIcon size={size} className={className} src={freshdeskSolutionIcon} />
);
