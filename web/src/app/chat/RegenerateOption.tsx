...
export default function RegenerateOption({
  ...
  // Only show the default model from the default provider
  const llmOptions = defaultProvider && defaultProvider.default_model_name ? 
    [{
      name: defaultProvider.default_model_name,
