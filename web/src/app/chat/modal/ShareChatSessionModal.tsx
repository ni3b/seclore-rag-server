...
// Fallback function to copy text if clipboard API is unavailable
                    ...
                    onClick={async () => {
                      try {
                        ...
                        if (!shareLink) {
                          ...
                          // Use clipboard API if available, else use fallback
              ...
              onClick={async () => {
                try {
                  ...
                  if (!seedLink) {
                    ...
                    // Use clipboard API if available, else use fallback
                    if (navigator.clipboard && navigator.clipboard.writeText) {
                      await navigator.clipboard.writeText(seedLink);
                      setPopup({
                        message: "Link copied to clipboard!",
                        type: "success",
                      });
                    } else {
                      copyToClipboardFallback(seedLink);
                    }
                  }
                } catch (e) {
                  console.error(e);
