...
# Image Model Server Configuration
IMAGE_MODEL_SERVER_HOST = (
    os.environ.get("IMAGE_MODEL_SERVER_HOST") or "localhost"
)
IMAGE_MODEL_SERVER_PORT = int(
    os.environ.get("IMAGE_MODEL_SERVER_PORT") or "9001"
)
IMAGE_MODEL_SERVER_TIMEOUT = int(
    os.environ.get("IMAGE_MODEL_SERVER_TIMEOUT") or "300"
)  # 5 minutes timeout for image processing

# Seclore custom Deep Learning Models
...
LOG_FILE_NAME = os.environ.get("LOG_FILE_NAME") or "seclore"
