...
{QUESTION_PAT.upper()} Seclore is unreachable.
```
{THOUGHT_PAT.upper()} The system searches documents related to Seclore being unreachable. \
Assuming the documents from search contains situations where Seclore is not reachable and \
