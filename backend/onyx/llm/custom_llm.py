...
from onyx.configs.model_configs import GEN_AI_NUM_RESERVED_OUTPUT_TOKENS, GEN_AI_TEMPERATURE
...
class CustomModelServer(LLM):
    """This class is to provide an example for how to use Seclore
    ...
    def __init__(
        ...
        if not endpoint:
            raise ValueError(
                "Cannot point Seclore to a custom LLM server without providing the "
