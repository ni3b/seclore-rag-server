...
# def get_connector_name(connector_credential_pair_id: int) -> str:
#     tenant_id = get_current_tenant_id()
    
#     with get_session_with_tenant(tenant_id) as db_session:
#         attempt = transition_attempt_to_in_progress(connector_credential_pair_id, db_session)
#         return attempt.connector_credential_pair.connector.name
...
def connector_indexing_task_wrapper(
    ...
    try:
        logger.info(f"connector_indexing_task_wrapper: {index_attempt_id}")
...
def connector_indexing_proxy_task(
    ...
    logger.info(f"connector_indexing_proxy_task: {self.request.id}")
