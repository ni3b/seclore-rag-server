...
def send_user_email_invite(user_email: str, current_user: User) -> None:
    subject = "Invitation to Join Seclore Organization"
    body = dedent(
        f"""\
        Hello,

        You have been invited to join an organization on Seclore.
...
def send_forgot_password_email(
    ...
    subject = "Seclore Forgot Password"
...
def send_user_verification_email(
    ...
    subject = "Seclore Email Verification"
