...
def handle_regular_answer(
    ...
    try:
        # By leaving time_range and favor_recent as None, and setting enable_auto_detect_filters
        # to True, we allow the system to automatically detect time filters from the query
        filters = BaseFilters(
            time_range=None,
            source_type=None,
            document_set=None,
